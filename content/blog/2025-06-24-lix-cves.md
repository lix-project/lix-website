...
Our view is that such a ban should probably become a systemd hardening option as systemd is the perfect place to put in a generic service-scoped mitigation as they use `cgroups` extensively.
